...
const List = () => {
  ...
  */
  ...
  const { shoesData, refetchShoes } = useShoes();

  // rendera skor - skicka med shoeData och refreshShoes
  const renderShoe = ({ item }) => (
    <Shoes shoeData={item} refreshShoes={refetchShoes} />
  );
  ...
  return (
    <SafeAreaView style={styles.scrollViewContainer}>
      <FlatList
        ...
        keyExtractor={(item) => item._id.toString()} // använder id som key
        ListHeaderComponent={
